...
CREATE TABLE `workflow_node_user` (
  ...
  `userId` int(11) NOT NULL COMMENT '操作用户（包括角色、用户、单位）',
  `userName` varchar(20) NOT NULL COMMENT '用户名称',
  `unitId` int(11) DEFAULT NULL COMMENT '单位编号',
  `unitName` varchar(45) DEFAULT NULL COMMENT '单位名称',
  `createdDate` datetime NOT NULL COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='节点操作用户（包括用户、单位）';
...
-- Dump completed on 2019-10-24 16:11:06
