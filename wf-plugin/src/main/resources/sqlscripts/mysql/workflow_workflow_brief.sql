...
CREATE TABLE `workflow_brief` (
  ...
  `stepId` int(11) DEFAULT NULL COMMENT '流程办理序号',
  `nodeName` varchar(20) NOT NULL COMMENT '节点名称',
  `actionName` varchar(20) DEFAULT NULL COMMENT '操作名称',
  `dispatchUserId` varchar(50) DEFAULT NULL COMMENT '办理人编号',
  ...
  `wfId` int(11) NOT NULL COMMENT '模块编号',
...
-- Dump completed on 2019-10-24 16:11:09
