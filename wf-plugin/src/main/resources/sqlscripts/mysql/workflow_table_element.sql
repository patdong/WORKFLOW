...
CREATE TABLE `table_element` (
  ...
  `emId` int(11) NOT NULL COMMENT '元素编号',
  `newLabelName` varchar(30) DEFAULT NULL COMMENT '字段标签名称',
  ...
  `newDataContent` varchar(50) DEFAULT NULL COMMENT '多选数据的信息',
  `newFieldType` varchar(10) NOT NULL DEFAULT '输入框' COMMENT '字段操作类型',
  `newFieldDataType` varchar(10) NOT NULL DEFAULT 'String' COMMENT '字段类型',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='表单元素';
