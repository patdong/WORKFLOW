...
--
-- Table structure for table `workflow_node_rels`
--

DROP TABLE IF EXISTS `workflow_node_rels`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `workflow_node_rels` (
  `nodeId` int(11) NOT NULL COMMENT '节点编号',
  `rel_nodeId` int(11) NOT NULL COMMENT '关联节点',
