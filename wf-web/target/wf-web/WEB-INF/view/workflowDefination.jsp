...
<script>
  ...
  var clickedNodeId = 0;
  //弹出操作菜单
  function showPos(event,cNodeId) {
	  var el, x, y;
...
<div class="container" style="padding-top:25px">
	<div id="content">
		<div style="padding:0em;margin:0px">
		  	<div >
		  		<h3 class="mt-5">流程定义</h3>	  		   		    
		  	</div>
		</div>			
	</div>
	<div class="line"></div>
	<div id="workflow" class="draw" style="margin-top: 12px;">
		<table style=" margin:5% 0 0 1%;border:0px solid">
			<tr>
				...
				<td><div class="circle-text" onclick="showPos(event,0)" ></div></td>							
			</tr>
		</table>
	</div>
</div>	
    ...
    <div style="padding: 0px 13px 0px;">
		<form id="myForm" class="navbar-form navbar-left" method="post" modelAttribute="node" action="/wfnode/savenode">
	  		<div class="popup-form-group">		        
		        ...
		        <input name="nodename" class="form-control-one-line" required autofocus placeholder="节点名称"  />			        		       
		    </div>		 
		    <div class="popup-form-group"> 
		    	<label for="nodeStatus" class="sr-only">节点状态</label> 
		        <input type="radio" name="nodeStatus" checked=checked>&nbsp;有效
		        <input type="radio" name="nodeStatus">&nbsp;无效			        
	        </div>		        	     
			        ...
			        <div class="navbar-inner">
		                ...
		                <ul class="nav" >			                    
		                    <li class="dropdown" id="accountmenu">
		                        <button type="button" id="roleName" class="btn btn-secondary btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="position:overflow;font-size: 1rem;">
							    	&nbsp;角色选择
							  	</button>
							  	<input type="hidden" name="role.roleId" id="role"/>
	        ...
	        <div style="margin-bottom:10px;margin-top:10px">
		    	<button class="btn btn-lg btn-primary " style="margin-right:20px;" type="submit" >保存</button>
		   </div> 			   
	   </form>
	</div>
...
<DIV id='PopUp-1' class="popup" >
	...
	<SPAN style="cursor:pointer;">插入</SPAN>
	<hr style="margin-top: 0.3rem;margin-bottom: 0.3rem;"></hr>
