...
<nav aria-label="Page navigation example">
  <ul class="pagination">  	
    	<c:if test="${! empty page.prePage}">
    		<li class="page-item">
    		  <div class="page-btn">
			      <a style="color: #e9eef3;" href="${path}${page.url}/${page.prePage}" aria-label="Previous">
    	...
    	<c:forEach items="${page.bodyPages}" varStatus="i" var="number" >
    		...
    		<li class="page-item">    			
    			<div <c:if test="${number == page.curPage }"> class="page-highlight-btn" </c:if> <c:if test="${number != page.curPage }"> class="page-btn" </c:if>>    			    			
    				<a style="color: #e9eef3;" href="${path}${page.url}/${number}">${number}</a>
    			</div>
    		</li>
    		</c:if>
    	</c:forEach>
    	<c:if test="${! empty page.nextPage}">
    		<li class="page-item">
    			<div class="page-btn">
			      <a style="color: #e9eef3;" href="${path}${page.url}/${page.nextPage}" aria-label="Next">
